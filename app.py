...
st.set_page_config(page_title="Smart Gaurdian")

# Page title and description
st.title("Project: Smart Gaurdian")
st.markdown(
    """
...
scene_button = col1.button("🖼️ Image Analysis")
ocr_button = col2.button("📜 Text reader")
tts_button = col3.button("🔈 Speak")
...
if uploaded_file:
    ...
    if ocr_button:
        with st.spinner("📜 Extracting text from the image..."):
            ...
            st.text_area("Text reader", ocr_text, height=150)
